...
('a01', 101, 'soklin', 500, 3000, '2023-03-12'), 
('a02', 102, 'shampo', 1000, 3000, '2022-11-24'), 
('a03', 103, 'proklin', 1000, 3000, '2023-09-12'), 
('a04', 104, 'downy', 500, 3000, '2022-4-12'), 
('a05', 105, 'rinso', 1000, 3000, '2020-10-15'), 
('a06', 106, 'lifboy', 3000, 3000, '202`0-8-17'), 
('a07', 107, 'nuvo', 3500, 3000, '2019-7-30'), 
('a08', 108, 'pastagigi', 5000, 3000, '2020-5-24'), 
('a09', 109, 'citra', 3000, 3000, '2022-10-25'), 
('a10', 110, 'pemutih', 1000, 3000, '2020-8-09'),
('a011', 130, 'laptop', 100, 30000, '2023-03-12'); 


SELECT * FROM transaksi_pelanggan;
UPDATE transaksi_pelanggan SET nama_barang='sapu' WHERE id_pelanggan='a01';
...
(09, 209, 'Pasmina', '2022-03-12', 'gasama'), 
(10, 210, 'Pasmina', '2022-03-12', 'gasama'); 
...
('c22', 'downy', 50, 1000), 
('c33', 'proklin', 50, 500), 
('c44', 'Energen', 250, 2000), 
('c55', 'Dancow', 100, 3500), 
('c66', 'Zee', 150, 3000), 
('c77', 'White Coffe', 100, 1500), 
('c88', 'Kapal Api', 90, 1500), 
('c99', 'Cokolates', 68, 3000), 
('c10', 'aline', 100, 3500); 

SELECT * FROM stok; 

-- DROP table transaksi_supplier; 
...
('PJ0009', 'Indra', 'B0009', 18, 2, 9000, 18000, '2022-01-09'), 
('PJ0010', 'Joko', 'B0010', 22, 4, 6000, 24000, '2022-01-10'); 
SELECT * FROM laporan_penjualan; 
 
CREATE TABLE koreksi_stok ( 
stok_barang INT PRIMARY KEY, 
