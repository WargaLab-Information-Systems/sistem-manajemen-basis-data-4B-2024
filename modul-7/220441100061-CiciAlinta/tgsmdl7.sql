...
('M 2323 AD', 'Suzuki', 'Suzuki Presso', '40000'),
('S 4567 LC', 'Honda', 'Brio', '30000'),
('B 1206 KL', 'Daihatsu', 'Ayla', '50000'),
('W 6767 CY', 'Toyota', 'Toyota Carolla', '10000'),
('M 3345 SU', 'Mitsubishi', 'Xpander', '20000');
SELECT * FROM mobil
...
INSERT INTO peminjaman (id_mobil, id_pelanggan,tgl_pinjam, tgl_rencana_kembali ) VALUE(1,1 , '2024-05-05', '2024-05-04' );
-- tgl_rencana_kembali < awal dari tgl_pinjam
INSERT INTO peminjaman (id_mobil, id_pelanggan,tgl_pinjam, tgl_rencana_kembali ) VALUE(1,1 , '2024-05-04', '2024-05-05' );
...
WHERE id_peminjaman = 2; -- Gantilah ID dengan  ID yang sesuai dari hasil insert sebelumnya
...
INSERT INTO pelanggan (nama, alamat, nik, no_telp, jenis_kelamin) VALUES
('fahmi', 'Lamongan', '4567890', '082586783290', 'Laki-laki');
...
INSERT INTO mobil ( platno, merk, jenis, harga_sewa_perhari) VALUES ('22345', 'Lamborgini', 'EXTRA', 90000);
-- penulisan yang benar
INSERT INTO mobil ( platno, merk, jenis, harga_sewa_perhari) VALUES ('JK 4644 SSN', 'Nissan', 'Nissan Promax', 80000);